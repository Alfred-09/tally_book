...
//        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setOutputDir("E:/workspacs/SpringBoot/demo/src/main/java");
        gc.setAuthor("Alfred");//作者
...
//        pc.setModuleName(scanner("模块名"));
       ...
       pc.setParent("com.alfred");//controller entity  service  service.impl
